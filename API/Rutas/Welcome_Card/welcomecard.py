...
def get_custom_image(avatar: str, background: str, ctx1: str, ctx2: str, ctx3: str):
    try:
        ...
        editor.text((320 + horizontal_shift, 260), ctx1, color="white", outline="black", font=poppins, align="center")
        editor.text((320 + horizontal_shift, 315), ctx2, color="white", outline="black", font=poppins_small, align="center")
        editor.text((320 + horizontal_shift, 350), ctx3, color="white", outline="black", font=poppins_small, align="center")
